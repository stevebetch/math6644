...
The one-dimensional equation given above can be solved with numeral method analysis or directly as a function of x. When solved directly, the equation becomes:
$$u(x) = -0.333333 x^3+0.25 x^2-1.91667 x+1
$$
The above equation then can be used to check the validity of the numerical methods. 
...
$$([S]_{j,k}=\sqrt{\frac{2}{n+1}}sin(\frac{\pi jk}{n+1})
$$
