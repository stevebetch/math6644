...
\end{lstlisting}
 ...
 where $C_n$ is the circulant, \mcode{fft} is the Fast Fourier Transform (FFT), and \mcode{ifft} is the inverse FFT. Once inverted, the circulant can then be passed to the Preconditioned Conjugate Gradient method for processing. The Chan preconditioner is created in a similar manner. 
