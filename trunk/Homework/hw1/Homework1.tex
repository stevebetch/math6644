...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=135mm]{gj.png}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=135mm]{gs.png}
...
$$
where $B=D^{-1}(E+F)$ and $\rho(B)$ is the spectral radius of $B$. For this discretized ODE, this value sits at $\approx 1.49375$. The effect of the $\omega$ on the convergence of the SOR method can be seen in Figure \ref{omega}. In this plot, 34 different values of $\omega$ were used in the SOR calculation to determine the number of iterations necessary to converge to a solution. The 34 points are not equally spaced in this plot, but rather, there are more points near the minima value of $\omega=1.49375$ to determine the actual best point. 

\begin{figure}[!h]
\begin{center}
\includegraphics[width=135mm]{omega.png}
\caption{Number of iterations necessary to converge to $10^{-8}$ vs $\omega$. The effects of $\omega$ on runtime can clearly be seen. }
\label{omega}
\end{center}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=135mm]{sor.png}
