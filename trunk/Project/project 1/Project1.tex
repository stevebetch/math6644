...
parfor j=1:runs(a)  %Parallel for loop
...
The $S$ matrix acted as a preconditioner to the tridiagonal A matrix. A preconditioner is used to make a In this particular problem, the preconditioned was split to achieve extremely fast convergence rates. Preconditioning the A matrix by $SAS^T$ results in a diagonal matrix. Preconditioning A with this matrix, and passing the inverse, $(SAS^{T})^{-1}$, to the PCG method results in an extremely fast convergence rate. While this method does require two matrix-matrix 
...
\hline
  n & CG iterations & CG runtime (sec) & PCG iterations & PCG runtime (sec) (sec)\ \\\hline
  258 &0.0194 & 0.0494& 0.5190 &0.00 \\\hline
  514 &0.0111 & 0.0564 & 0.0196 &0.00 \\\hline
  1026 &0.0423 & 0.0771 & 0.0706 &0.00 \\\hline
  2050 &0.1704 & 0.1439 & 0.2003 &0.00  \\\hline
  4098 &0.5087 & 0.4694 &1.1024 &0.00  \\\hline
  8194 &8.1068 & 1.9299 & 3.9583 &0.00 \\\hline
  16386 &37.3268 & 7.9876 & 29.3784 &0.00 \\\hline
  % Design2 &300 & 380 & 370 & 34 & 40& 400& 100& 50& 100& 100 \\\hline
%  Design3 &300 & 600 & 580 & 40 & 50& 550& 100& 150& 200& 250 \\\hline
